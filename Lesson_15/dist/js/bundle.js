...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var f=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),p=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),v=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),h=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),y=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),g="prototype",b=function(e,o,s){var t,n,r,u,d=e&b.F,c=e&b.G,l=e&b.S,i=e&b.P,a=e&b.B,m=c?f:l?f[o]||(f[o]={}):(f[o]||{})[g],j=c?p:p[o]||(p[o]={}),_=j[g]||(j[g]={});for(t in c&&(s=o),s)r=((n=!d&&m&&void 0!==m[t])?m:s)[t],u=a&&n?y(r,f):i&&"function"==typeof r?y(Function.call,r):r,m&&h(m,t,r,e&b.U),j[t]!=r&&v(j,t,u),i&&_[t]!=r&&(_[t]=r)};f.core=p,b.F=1,b.G=2,b.S=4,b.P=8,b.B=16,b.W=32,b.U=64,b.R=128,e.exports=b},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!*****************************************************!*\
  ...
  \*****************************************************/
/*! no static exports found */function(e,o,s){"use strict";var t,n,r,u,d=s(/*! ./_library */"./node_modules/core-js/modules/_library.js"),c=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),l=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),i=s(/*! ./_classof */"./node_modules/core-js/modules/_classof.js"),a=s(/*! ./_export */"./node_modules/core-js/modules/_export.js"),m=s(/*! ./_is-object */"./node_modules/core-js/modules/_is-object.js"),j=s(/*! ./_a-function */"./node_modules/core-js/modules/_a-function.js"),_=s(/*! ./_an-instance */"./node_modules/core-js/modules/_an-instance.js"),f=s(/*! ./_for-of */"./node_modules/core-js/modules/_for-of.js"),p=s(/*! ./_species-constructor */"./node_modules/core-js/modules/_species-constructor.js"),v=s(/*! ./_task */"./node_modules/core-js/modules/_task.js").set,h=s(/*! ./_microtask */"./node_modules/core-js/modules/_microtask.js")(),y=s(/*! ./_new-promise-capability */"./node_modules/core-js/modules/_new-promise-capability.js"),g=s(/*! ./_perform */"./node_modules/core-js/modules/_perform.js"),b=s(/*! ./_user-agent */"./node_modules/core-js/modules/_user-agent.js"),x=s(/*! ./_promise-resolve */"./node_modules/core-js/modules/_promise-resolve.js"),w="Promise",S=c.TypeError,k=c.process,L=k&&k.versions,E=L&&L.v8||"",O=c[w],T="process"==i(k),M=function(){},P=n=y.f,A=!!function(){try{var e=O.resolve(1),o=(e.constructor={})[s(/*! ./_wks */"./node_modules/core-js/modules/_wks.js")("species")]=function(e){e(M,M)};return(T||"function"==typeof PromiseRejectionEvent)&&e.then(M)instanceof o&&0!==E.indexOf("6.6")&&-1===b.indexOf("Chrome/66")}catch(e){}}(),R=function(e){var o;return!(!m(e)||"function"!=typeof(o=e.then))&&o},C=function(i,s){if(!i._n){i._n=!0;var t=i._c;h(function(){for(var c=i._v,l=1==i._s,e=0,o=function(e){var o,s,t,n=l?e.ok:e.fail,r=e.resolve,u=e.reject,d=e.domain;try{n?(l||(2==i._h&&F(i),i._h=1),!0===n?o=c:(d&&d.enter(),o=n(c),d&&(d.exit(),t=!0)),o===e.promise?u(S("Promise-chain cycle")):(s=R(o))?s.call(o,r,u):r(o)):u(c)}catch(e){d&&!t&&d.exit(),u(e)}};t.length>e;)o(t[e++]);i._c=[],i._n=!1,s&&!i._h&&q(i)})}},q=function(r){v.call(c,function(){var e,o,s,t=r._v,n=I(r);if(n&&(e=g(function(){T?k.emit("unhandledRejection",t,r):(o=c.onunhandledrejection)?o({promise:r,reason:t}):(s=c.console)&&s.error&&s.error("Unhandled promise rejection",t)}),r._h=T||I(r)?2:1),r._a=void 0,n&&e.e)throw e.v})},I=function(e){return 1!==e._h&&0===(e._a||e._c).length},F=function(o){v.call(c,function(){var e;T?k.emit("rejectionHandled",o):(e=c.onrejectionhandled)&&e({promise:o,reason:o._v})})},D=function(e){var o=this;o._d||(o._d=!0,(o=o._w||o)._v=e,o._s=2,o._a||(o._a=o._c.slice()),C(o,!0))},H=function(e){var s,t=this;if(!t._d){t._d=!0,t=t._w||t;try{if(t===e)throw S("Promise can't be resolved itself");(s=R(e))?h(function(){var o={_w:t,_d:!1};try{s.call(e,l(H,o,1),l(D,o,1))}catch(e){D.call(o,e)}}):(t._v=e,t._s=1,C(t,!1))}catch(e){D.call({_w:t,_d:!1},e)}}};A||(O=function(e){_(this,O,w,"_h"),j(e),t.call(this);try{e(l(H,this,1),l(D,this,1))}catch(e){D.call(this,e)}},(t=function(e){this._c=[],this._a=void 0,this._s=0,this._d=!1,this._v=void 0,this._h=0,this._n=!1}).prototype=s(/*! ./_redefine-all */"./node_modules/core-js/modules/_redefine-all.js")(O.prototype,{then:function(e,o){var s=P(p(this,O));return s.ok="function"!=typeof e||e,s.fail="function"==typeof o&&o,s.domain=T?k.domain:void 0,this._c.push(s),this._a&&this._a.push(s),this._s&&C(this,!1),s.promise},catch:function(e){return this.then(void 0,e)}}),r=function(){var e=new t;this.promise=e,this.resolve=l(H,e,1),this.reject=l(D,e,1)},y.f=P=function(e){return e===O||e===u?new r(e):n(e)}),a(a.G+a.W+a.F*!A,{Promise:O}),s(/*! ./_set-to-string-tag */"./node_modules/core-js/modules/_set-to-string-tag.js")(O,w),s(/*! ./_set-species */"./node_modules/core-js/modules/_set-species.js")(w),u=s(/*! ./_core */"./node_modules/core-js/modules/_core.js")[w],a(a.S+a.F*!A,w,{reject:function(e){var o=P(this);return(0,o.reject)(e),o.promise}}),a(a.S+a.F*(d||!A),w,{resolve:function(e){return x(d&&this===u?O:this,e)}}),a(a.S+a.F*!(A&&s(/*! ./_iter-detect */"./node_modules/core-js/modules/_iter-detect.js")(function(e){O.all(e).catch(M)})),w,{all:function(e){var u=this,o=P(u),d=o.resolve,c=o.reject,s=g(function(){var t=[],n=0,r=1;f(e,!1,function(e){var o=n++,s=!1;t.push(void 0),r++,u.resolve(e).then(function(e){s||(s=!0,t[o]=e,--r||d(t))},c)}),--r||d(t)});return s.e&&c(s.v),o.promise},race:function(e){var o=this,s=P(o),t=s.reject,n=g(function(){f(e,!1,function(e){o.resolve(e).then(s.resolve,t)})});return n.e&&t(n.v),s.promise}})},"./node_modules/core-js/modules/es6.regexp.exec.js":
/*!*********************************************************!*\
...
/*!*******************************!*\
  ...
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js"),s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var r="Загрузка...",u="Спасибо! Скоро мы с вами свяжемся!",d="Что-то пошло не так...",e=document.querySelector(".main-form"),o=document.querySelectorAll("input[type=tel]"),c=document.createElement("div"),s=document.getElementById("form");document.querySelectorAll("input"),o.forEach(function(o){o.addEventListener("keydown",function(e){/\d|\+/gm.test(e.key)||8==e.keyCode||e.preventDefault(),-1!=o.value.indexOf("+")&&"+"==e.key&&e.preventDefault()})}),c.classList.add("status"),[e,s].forEach(function(n){n.addEventListener("submit",function(e){e.preventDefault(),n.appendChild(c);var t,o=n.getElementsByTagName("input"),s=new FormData(n);(t=s,new Promise(function(e,o){var s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-type","application/x-www-form-urlencoded"),s.onreadystatechange=function(){s.readyState<4?e():4===s.readyState&&(200==s.status&&4==s.readyState?e():o())},s.send(t)})).then(function(){return c.innerHTML=r}).then(function(){return c.innerHTML=u}).catch(function(){return c.innerHTML=d}).then(function(){return function(){for(var e=0;e<o.length;e++)o[e].value=""}()})})})}},"./src/js/parts/modal.js":
/*!*******************************!*\
  !*** ./src/js/parts/modal.js ***!
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),o.default=function(){var e=document.querySelector(".more"),s=document.querySelector(".overlay"),o=document.querySelector(".popup-close");e.addEventListener("click",function(){s.style.display="block",this.classList.add("none"),document.body.style.overflow="hidden"}),o.addEventListener("click",function(){s.style.display="none",e.classList.remove("more-splash"),document.body.style.overflow=""}),document.querySelector(".info").addEventListener("click",function(e){var o=e.target;o&&o.classList.contains("description-btn")&&(s.style.display="block",o.classList.add("more-splash"),document.body.style.overflow="hidden")})}},"./src/js/parts/slider.js":
/*!********************************!*\
...
/*!**************************!*\
  !*** ./src/js/script.js ***!
  \**************************/
/*! no exports provided */function(e,o,s){"use strict";s.r(o);var t=s(/*! ./parts/calc.js */"./src/js/parts/calc.js"),n=s(/*! ./parts/forms.js */"./src/js/parts/forms.js"),r=s(/*! ./parts/slider.js */"./src/js/parts/slider.js"),u=s(/*! ./parts/modal.js */"./src/js/parts/modal.js"),d=s(/*! ./parts/tabs.js */"./src/js/parts/tabs.js"),c=s(/*! ./parts/timer.js */"./src/js/parts/timer.js");window.addEventListener("DOMContentLoaded",function(){Object(t.default)(),Object(n.default)(),Object(u.default)(),Object(r.default)(),Object(d.default)(),Object(c.default)()})}});